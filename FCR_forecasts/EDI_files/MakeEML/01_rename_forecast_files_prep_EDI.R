...
new_folder <- './FCR_forecasts/EDI_files/forecast_output_EDI'
...
old_folder <- './FCR_forecasts/1day/Mar2021_UC/uncertainty_2_process'
names <- list.files(path = old_folder, pattern = '*chla_1day.csv')
...
old_folder <- './FCR_forecasts/1day/Mar2021_UC/uncertainty_3_weather'
names <- list.files(path = old_folder, pattern = '*chla_1day.csv')
...
old_folder <- './FCR_forecasts/1day/Mar2021_UC/uncertainty_4_initial_condition'
names <- list.files(path = old_folder, pattern = '*chla_1day.csv')
...
old_folder <- './FCR_forecasts/1day/Mar2021_UC/uncertainty_5_parameter'
names <- list.files(path = old_folder, pattern = '*chla_1day.csv')
...
old_folder <- './FCR_forecasts/1day/Mar2021_UC/uncertainty_6_discharge'
names <- list.files(path = old_folder, pattern = '*chla_1day.csv')
...
old_folder <- './FCR_forecasts/7day/Mar2021_UC'
...
old_folder <- './FCR_forecasts/7day/Mar2021_UC/uncertainty_2_process'
names <- list.files(path = old_folder, pattern = '*chla_7day.csv')
...
old_folder <- './FCR_forecasts/7day/Mar2021_UC/uncertainty_3_weather'
names <- list.files(path = old_folder, pattern = '*chla_7day.csv')
...
old_folder <- './FCR_forecasts/7day/Mar2021_UC/uncertainty_4_initial_condition'
names <- list.files(path = old_folder, pattern = '*chla_7day.csv')
...
old_folder <- './FCR_forecasts/7day/Mar2021_UC/uncertainty_5_parameter'
names <- list.files(path = old_folder, pattern = '*chla_7day.csv')
...
old_folder <- './FCR_forecasts/7day/Mar2021_UC/uncertainty_6_discharge'
names <- list.files(path = old_folder, pattern = '*chla_7day.csv')
newNames <- sub("chla_7day.csv", "chla_7day_uncert6.csv", names)
file.copy(from = paste0(old_folder, "/", names), to = paste0(new_folder, "/", newNames))

# do again for the 14day forecasts
old_folder <- './FCR_forecasts/14day/Mar2021_UC'
...
old_folder <- './FCR_forecasts/14day/Mar2021_UC/uncertainty_2_process'
names <- list.files(path = old_folder, pattern = '*chla_14day.csv')
...
old_folder <- './FCR_forecasts/14day/Mar2021_UC/uncertainty_3_weather'
names <- list.files(path = old_folder, pattern = '*chla_14day.csv')
...
old_folder <- './FCR_forecasts/14day/Mar2021_UC/uncertainty_4_initial_condition'
names <- list.files(path = old_folder, pattern = '*chla_14day.csv')
...
old_folder <- './FCR_forecasts/14day/Mar2021_UC/uncertainty_5_parameter'
names <- list.files(path = old_folder, pattern = '*chla_14day.csv')
...
old_folder <- './FCR_forecasts/14day/Mar2021_UC/uncertainty_6_discharge'
names <- list.files(path = old_folder, pattern = '*chla_14day.csv')
