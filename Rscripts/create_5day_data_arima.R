...
train <- train %>% mutate(Chla_ARlag_timestep_sqrt = lag(Chla_sqrt, 5L))
days <- seq(as.Date('2018-08-15'), as.Date('2019-12-22'), by = '5 days')
...
write.csv(train, paste0(folder, '/data_arima_5day_through_2019.csv'), row.names = FALSE)
