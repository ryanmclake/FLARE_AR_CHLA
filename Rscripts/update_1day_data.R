...
data$Date <- as.Date(data$Date)
  ...
  reference_tzone <- "EST"
  full_time = seq(tail(data$Date, n=1), as.Date(Sys.time()) , by = timestep_numeric)
 ...
 # first for data in 2019 (have to do this separately because met data file is separated by year)
