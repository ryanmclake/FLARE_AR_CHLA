...
timestep <- '14day'
forecast_folder <- paste0(folder, "/FCR_forecasts", '/', timestep, '/22Jul2020')
...
png('C:/Users/wwoel/Dropbox/Thesis/Figures/arima/fortnightly_parameter_timeseries.png', width = 1100, height = 800)
