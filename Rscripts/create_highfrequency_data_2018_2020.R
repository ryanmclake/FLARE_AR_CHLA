...
reference_tzone <- "EST"
full_time = seq(as.Date('2018-08-14'), as.Date('2020-9-01'), by = '1 day')
...
met_hist_daily_2018 <- met_hist_daily_2018 %>% select(Date, ShortWave_mean)
...
met_hist_daily <- rbind(met_hist_daily_2018, met_hist_daily_2019, met_hist_daily_2020)
...
write.csv(data, paste0(folder, '/training_datasets/data_arima_1day_through_2020.csv'), row.names = FALSE)
