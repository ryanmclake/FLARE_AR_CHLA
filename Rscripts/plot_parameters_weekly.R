...
forecast_folder <- paste0(folder, '/FCR_forecasts/weekly/weekly_dischargeforecast_Apr2020/')
...
myfiles_forecast <- list.files(path = forecast_folder, pattern = "*weekly.csv")
...
plot(week1$forecast_date, week1$par1, xlab = '', ylab = 'intercept par', type = 'l', axes = F, cex.lab = 3)
...
plot(week1$forecast_date, week1$par2, xlab = '', type = 'l', ylab = 'chlorophyll par', axes = F,cex.lab = 2, cex.lab = 3)
axis(2, cex.axis = 3, cex.lab = 5)
axis.Date(side=1,at=xseq,format='%y-%b',labels=T,las=3, cex.axis = 3)
abline(v = as.Date("2019-07-15", "%Y-%m-%d"), col = 'blue')
abline(v = as.Date("2019-08-15", "%Y-%m-%d"), col = 'blue')
plot(week1$forecast_date, week1$par3, xlab = '', ylab = 'discharge par', type = 'l', cex.lab = 2, axes = F,cex.lab = 3)
axis(2, cex.axis = 3, cex.lab = 5)
axis.Date(side=1,at=xseq,format='%y-%b',labels=T,las=3, cex.axis = 3)
abline(v = as.Date("2019-07-15", "%Y-%m-%d"), col = 'blue')
abline(v = as.Date("2019-08-15", "%Y-%m-%d"), col = 'blue')
plot(week1$forecast_date, week1$par4, xlab = '', ylab = 'sw par', type = 'l', cex.lab = 2, axes = F,cex.lab = 3)
axis(2, cex.axis = 3, cex.lab = 5)
axis.Date(side=1,at=xseq,format='%y-%b',labels=T,las=3, cex.axis = 3)
abline(v = as.Date("2019-07-15", "%Y-%m-%d"), col = 'blue')
abline(v = as.Date("2019-08-15", "%Y-%m-%d"), col = 'blue')
