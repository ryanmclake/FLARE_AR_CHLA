...
flow <- read.csv('./Data/Inflow/FCR_inflow_WVWA_2013_2019.csv')
...
data_interp <- read.csv('./Data/ARIMA_data/data_arima_WW.csv')
...
png('./Writing/Ch 1 AR Forecasts/SI Materials/Interpolation_Fig.png', width = 1200, height = 785)
